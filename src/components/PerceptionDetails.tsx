...
const PerceptionDetails = ({ constructData, pinnacleData }: PerceptionDetailsProps) => {
  return (
    <motion.div 
    ...
    >
      ...
      {/* Perception-specific insights could go here */}
      <div className="mt-8 p-4 bg-indigo-50 rounded-md">
        <h4 className="font-medium text-indigo-800 mb-2">Brand Perception Insights</h4>
        <p className="text-sm text-gray-700">
          Your brand perception is facing significant challenges across key metrics. Customer sentiment 
          analysis indicates mixed reviews with a trend toward negative experiences. Market positioning 
          is significantly behind industry leaders, particularly in areas of trust and customer satisfaction.
        </p>
      </div>
