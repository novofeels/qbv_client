...
const CompetitionDetails = ({ constructData, pinnacleData }: CompetitionDetailsProps) => {
  return (
    <motion.div 
    ...
    >
      ...
      <div className="mt-8 p-4 bg-purple-50 rounded-md">
        <h4 className="font-medium text-purple-800 mb-2">Competitive Positioning</h4>
        <p className="text-sm text-gray-700">
          Your brand is positioned significantly behind major competitors in key performance indicators.
          Market share analysis shows limited presence in primary service areas compared to major players.
          Competitive benchmarks reveal significant gaps in digital touchpoint effectiveness and customer acquisition rates.
        </p>
      </div>
